<footer class="bg-dark mt-5">
            ...
            <div class="col-lg-10 mx-auto text-center">
                <a class="d-inline-block mb-4 pb-2" href="/">
                    <img loading="prelaod" decoding="async" class="img-fluid" src="{{blogInfo()->blog_logo}}"
                        alt="{{blogInfo()->blog_name}}" style="width: 100px">
                </a>
                <ul class="p-0 d-flex navbar-footer mb-0 list-unstyled">
                    ...
                    <li class="nav-item my-0"> <a class="nav-link" href="terms-conditions.html">Terms Conditions</a>
                    </li>
    ...
    <div class="copyright bg-dark content">&copy; <script>document.write(new Date().getFullYear())</script> Developed By <a
